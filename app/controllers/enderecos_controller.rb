class EnderecosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @endereco.save
        format.html { redirect_to @endereco, notice: 'Endereco foi criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @endereco.update(endereco_params)
        format.html { redirect_to @endereco, notice: 'Endereco foi atualizado com sucesso.' }
  ...
  def destroy
    @endereco.destroy
    respond_to do |format|
      format.html { redirect_to enderecos_url, notice: 'Endereco foi excluido com sucesso.' }
  ...
  private
    ...
    def endereco_params
      params.require(:endereco).permit(:endereco, :numero, :referencia, :obs, :cep, :cidade_id)
    end
end
