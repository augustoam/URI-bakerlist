require 'devise'
#require 'support/controllers/controller_macros'
#require 'support/requests/request_helpers'
# Require Capybara para funcionar com o guard
...
# Indica testes parciais quando chamados via Guard ou plugin RubyTest do SublimeText
running_partial_tests = ENV['PARTIAL_TESTS'] || ARGV.join("") =~ /:\d+$/

SimpleCov.minimum_coverage 100 unless running_partial_tests

# Driver Poltergeist para permitir execução de javascript nos testes
require 'capybara/poltergeist'

# Capybara.register_driver :poltergeist do |app|
  # Capybara::Poltergeist::Driver.new(app, {debug: true, :timeout => 30, :inspector => true})
# end
...
RSpec.configure do |config|
  ...
  config.before(:suite) do
    FileUtils.rm_rf "#{Rails.root}/coverage" unless ARGV.include?('--only-failures')
  ...
  # Salva o status do teste em arquivo para poder rodar com argumento --only-failures
  config.example_status_persistence_file_path = File.join("tmp", "rspec-example-status.txt")

  # Permite rodar testes colocando a tag :focus
